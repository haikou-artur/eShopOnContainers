...
public class NewOrderRequestHandlerTest
{
    ...
    {
        return new Order("1", "fakeName", new Address("street", "city", "state", "country", "zipcode"), 1, "12", "111", "fakeName", DateTime.Now.AddYears(1), "DISC-10", 10, 1);
    }
    ...
    private CreateOrderCommand FakeOrderRequestWithBuyer(Dictionary<string, object> args = null)
    {
        return new CreateOrderCommand(
            ...
            discountCode: args != null && args.ContainsKey("discountCode") ? (string)args["discountCode"] : null,
            discount: args != null && args.ContainsKey("discount") ? (int)args["discount"] : 0,
            points: args != null && args.ContainsKey("points") ? (int)args["points"] : 0);
    }
}
